...
물론 우리가 의존하는 서비스를 건드리지 않고 [contract testing](https://docs.pact.io/#what-is-contract-testing)에 100% 의존하는 문제점이 있었습니다. 하지만 위의 방식으로 작성된 테스트를 실행하면 단일 프로세스에서 100초 동안 약 3,000개 테스트를 수행할 수 있었습니다.
